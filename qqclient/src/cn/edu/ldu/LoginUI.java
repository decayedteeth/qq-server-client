...
public class LoginUI extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnGetPassword.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		btnGetPasswordActionPerformed(e);
        	}
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtRemoteName, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(39, 39, 39)
                .addComponent(jLabel3)
                .addGap(18, 18, 18)
                .addComponent(txtRemotePort, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
	...
	private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {
        try {
			...
			int remotePort=Integer.parseInt(txtRemotePort.getText());
	    	Message msg=new Message();
	        RegisterUI regis=new RegisterUI(remoteAddr,remotePort,msg); //创建客户机界面
	        regis.setVisible(true);//显示注册窗体； 
	        this.dispose();//关闭登录对话框
	...
	@SuppressWarnings("unused")
	private void btnGetPasswordActionPerformed(java.awt.event.ActionEvent evt) {
		try {
        	String remoteName=txtRemoteName.getText();
			InetAddress remoteAddr=InetAddress.getByName(remoteName);
			int remotePort=Integer.parseInt(txtRemotePort.getText());
	    	Message msg=new Message();
	        remeber rem=new remeber(remoteAddr,remotePort,msg); //创建客户机界面 
	        this.dispose();//关闭登录对话框
		} catch (UnknownHostException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
