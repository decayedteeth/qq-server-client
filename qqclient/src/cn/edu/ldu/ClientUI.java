...
//            Message backMsg = (Message)Translate.ByteToObject(data);
            JFileChooser fileChooser = new JFileChooser("../qqserver/upload");
			fileChooser.setDialogTitle("选择下载文件");
            fileChooser.setApproveButtonText("选择");
//            downFileUI df = new downFileUI(backMsg.getFlielist());
//            df.setVisible(true);
//            while (ClientUI.fName==null) {System.out.println("1");}
